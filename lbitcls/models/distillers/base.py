...
class BaseDistiller(nn.Module, metaclass = ABCMeta):
    """Base class for distillers."""

    def __init__(self):
        super(BaseDistiller, self).__init__()
    
    @property
    def with_student_model(self):
        return hasattr(self, 'student_model') and self.student_model is not None
    
    @property
    def with_teacher_model(self):
