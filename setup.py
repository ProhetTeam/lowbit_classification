...
version_file = 'lbitcls/version.py'
...
def get_hash():
    if os.path.exists('.git'):
        ...
        try:
            from lbitcls.version import __version__
...
"""
    sha = get_hash()
    with open('lbitcls/VERSION', 'r') as f:
...
if __name__ == "__main__":
    ...
    setup(
        name='lbitcls',
        version=get_version(),
        description='low bit training classification sysytem',
